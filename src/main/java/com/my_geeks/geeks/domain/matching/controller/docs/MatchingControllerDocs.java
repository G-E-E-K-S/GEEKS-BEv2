...
public interface MatchingControllerDocs {
    ...
    public BaseResponse<GetPointRes> points(Long userId);
    ...
    public BaseResponse<GetPointRes> pointsTop3(Long userId);
    ...
    public BaseResponse<GetMatchingDetailRes> matchingDetail(Long matchingId, Long opponentId, Long userId);
}
